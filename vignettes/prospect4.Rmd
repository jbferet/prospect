...
Appart from the samples, __the performances are identical__. If inversion does not succeed, a message is displayed, but the process coan continue (values to be estimatd will then be set to NA).
