...
# Get wavelengths corresponding to the reflectance and transmittance measurements  
...
Nprior_R <- Get_Nprior(lambda = lambda, Refl = Refl)
# Prior estimation of N using T only
Nprior_T <- Get_Nprior(lambda = lambda, Tran = Tran)
```
