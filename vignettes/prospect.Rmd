...
vignette: >
  ...
  %\VignetteIndexEntry{Introduction to `prospect`}
...
url <- "https://gitlab.com/jbferet/myshareddata/-/raw/master/prospect_vignette_illustrations/PROSPECT_representation_Full_Crop.png"
...
```{r, eval=TRUE, echo = FALSE, out.width="100%"}
url <- "https://gitlab.com/jbferet/myshareddata/-/raw/master/prospect_vignette_illustrations/PROSPECT_DirectInverse_crop.png"
knitr::include_graphics(url)
```
<p>&nbsp;</p>
<center>
