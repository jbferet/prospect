...
for (i in 1:nbSamples[[1]]){
  print(i)
  res <- Invert_PROSPECT(SpecPROSPECT, Refl = Refl[,i], Tran = Tran[,i], 
...
<p float="left">
  <img src="../man/figures/CHL_Rall.png" width="50%" />
  <img src="../man/figures/CAR_Rall.png" width="50%" />
</p>
<p float="left">
  <img src="../man/figures/EWT_Rall.png" width="50%" />
  <img src="../man/figures/LMA_Rall.png" width="50%" />
</p>
<center>
...
<p float="left">
  <img src="../man/figures/CHL_R.png" width="50%" />
  <img src="../man/figures/CAR_R.png" width="50%" />
</p>
<p float="left">
  <img src="../man/figures/EWT_R.png" width="50%" />
  <img src="../man/figures/LMA_R.png" width="50%" />
</p>
<center>
